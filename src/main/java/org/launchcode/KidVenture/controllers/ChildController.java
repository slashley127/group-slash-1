...
public class ChildController {
    ...
    @PutMapping("/child/{id}/{emergencyContactId}")
    public Child addEmergencyContactToChild(@PathVariable int id, @PathVariable int emergencyContactId, @RequestBody Child child, @RequestBody EmergencyContact emergencyContact) {
        Child childProf = childRepository.findById(id).get();
        EmergencyContact emergencyContactProf = emergencyContactRepository.findById(emergencyContactId).get();
        child.addEmergencyContact(emergencyContactProf);
        return childRepository.save(childProf);
    }
